 ...
 */
public class DrillgisFeatureInputStream extends BaseFeatureInputStream {
    ...
    private DrillgisResultSetConverter mapper;

    int geometryColIndex = -1;
    String externalIdentifier = null;  // added on 2013-08-07

    public DrillgisFeatureInputStream(Connection conn, String queryString) {
        this.conn = conn;
        this.queryString = queryString;
    }

    public DrillgisFeatureInputStream(Connection conn, String queryString, String externalIdentifier) {
        this.conn = conn;
        this.queryString = queryString;
    ...
    private void init() throws SQLException {
        ...
        mapper = new DrillgisResultSetConverter(conn, rs);
