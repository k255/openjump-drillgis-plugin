 ...
 * provided ResultSet
 */
public class DrillgisResultSetConverter {

    private ResultSet rs;
    private FeatureSchema featureSchema;
    private int geometryColIndex = -1;
    private ValueConverter[] mapper;
    private DrillgisValueConverterFactory odm;
    private boolean isInitialized = false;

    public DrillgisResultSetConverter(Connection conn, ResultSet rs) {
        odm = new DrillgisValueConverterFactory(conn);
        this.rs = rs;
    }
