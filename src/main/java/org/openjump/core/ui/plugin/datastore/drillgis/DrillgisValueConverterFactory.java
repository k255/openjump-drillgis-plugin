 ...
 *
 */
public class DrillgisValueConverterFactory {
    ...
    public DrillgisValueConverterFactory(Connection conn) {
    this.conn = conn;
  }
    ...
    public ValueConverter getConverter(ResultSetMetaData rsm, int columnIndex) throws SQLException {
        ...
        if ("VARBINARY".equals(dbTypeName) || "BINARY VARYING".equals(dbTypeName) || "geometry".equals(udt))
